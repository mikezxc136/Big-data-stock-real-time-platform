        ...
        if (value instanceof Struct) {
            ...
            if (dateField != null) {
                ...
                if (dateField instanceof Timestamp) {
                    Timestamp dateValue = (Timestamp) dateField;
                    ZonedDateTime zonedDateTime = dateValue.toInstant().atZone(ZoneId.systemDefault());
                    System.out.println("Date field timezone: " + zonedDateTime.getZone());
                    Timestamp newValue = new Timestamp(dateValue.getTime() - SUBTRACT_VALUE);
